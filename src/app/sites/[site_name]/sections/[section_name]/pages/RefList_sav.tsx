  ...
  return (
    <Box sx={{ mt: 4 }}>
      ...
      <List>
        {refs.map((ref) => (
          <ListItem key={ref.id}>
            <ListItemText primary={ref.title} secondary={ref.url} />
      ...
      <TextField fullWidth label="Title" value={newRef.title} onChange={(e) => setNewRef({ ...newRef, title: e.target.value })} sx={{ mt: 2 }} />
